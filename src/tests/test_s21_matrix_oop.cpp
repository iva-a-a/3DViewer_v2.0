...
TEST(S21MatrixTest, OperatorSubtraction) {
    ...
    matrix1(1, 0) = 7.0; matrix1(1, 1) = 8.0;

    matrix2(0, 0) = 1.0; matrix2(0, 1) = 2.0;
    matrix2(1, 0) = 3.0; matrix2(1, 1) = 4.0;
...
TEST(S21MatrixTest, ExceptionInverseMatrixZeroDeterminant) {
    S21Matrix matrix(2, 2);
    matrix(0, 0) = 1.0; matrix(0, 1) = 2.0;
    matrix(1, 0) = 2.0; matrix(1, 1) = 4.0; // det = 0
